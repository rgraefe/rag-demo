...
CITATION_QA_PROMPT = PromptTemplate(
    CITATION_QA_TEMPLATE, prompt_type=PromptType.QUESTION_ANSWER
)


# variant for chat
##################
CITATION_QA_SYSTEM_PROMPT = ChatMessage(
    content=(
...
CITATION_CHAT_QA_PROMPT = ChatPromptTemplate(message_templates=CITATION_QA_PROMPT_TMPL_MSGS)

####################
# REFINE template  #
####################
########################
# default REFINE variant
########################
...
CITATION_REFINE_PROMPT = PromptTemplate(
    CITATION_REFINE_TEMPLATE, prompt_type=PromptType.REFINE
)
...
# variant for chat
##################
CITATION_CHAT_REFINE_PROMPT_TMPL_MSGS = [
    ChatMessage(
        content=(
...
CITATION_CHAT_REFINE_PROMPT = ChatPromptTemplate(message_templates=CITATION_CHAT_REFINE_PROMPT_TMPL_MSGS)

###########################################################
# below are the default and chat templates                #
# modify them to cite templates when it becomes necessary #
###########################################################
