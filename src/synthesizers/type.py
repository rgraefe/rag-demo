...
class CiteResponseMode(str, Enum):
    ...
    CITE_SIMPLE_SUMMARIZE = "cite_simple_summarize"
    """
    ...
    CITE_TREE_SUMMARIZE = "cite_tree_summarize"
    """
