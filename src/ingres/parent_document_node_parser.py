...
class ParagraphOnlyFilter(TransformComponent):
    def __call__(self, nodes, **kwargs):
        return [
            n for n in nodes
            if n.metadata.get("node_level") == "paragraph"
        ]
...
class ParentDocumentNodeParser(NodeParser):
        ...
        **kwargs: Any,
        ...
        for node in nodes_with_progress:
            ...
            if node_type == "section":
                ...
                child_index = child_counters.get(section_key, 0)
                child_counters[section_key] = child_index + 1
    ...
    def _process_list_item(
        ...
        if parent_id:
            ...
            metadata["article_child_index"] = child_index
